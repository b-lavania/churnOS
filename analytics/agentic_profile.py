...
PRESETS: dict[str, dict[str, Any]] = {
    ...
    "marketplace_agentic": {
        "preset_id": "marketplace_agentic",
        "label": "Marketplace (agent-assisted GMV)",
        "ontology_vertical": "marketplace_commerce",
        "ontology_version": "marketplace_commerce_v1",
        "billing_model": "usage_based",
        "default_model": "gpt-4o",
        "max_loops_threshold": 10,
        "cache_hit_rate": 0.6,
        "description": "Two-sided marketplace with agent-assisted quotes, listings, and checkout. Platform take must cover inference cost.",
        "priors": {
            "n_seats": 500,
            "n_capabilities": 8,
            "activation_rate": 0.55,
            "weekly_habit_rate": 0.45,
            "approval_fatigue_rate": 0.18,
            "trust_incident_rate": 0.04,
            ...
            "monthly_churn_base": 0.06,
            "revenue_per_1k_tokens": 0.03,
            "agent_assist_share": 0.45,
            "take_rate": 0.12,
            "verification_rate": 0.75,
            "inference_cost_share_of_take": 0.35,
        },
    },
}
